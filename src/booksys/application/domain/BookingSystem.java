...
public class BookingSystem
{
  ...
  {
    Enumeration<BookingObserver> e = observers.elements() ;
    while (e.hasMoreElements()) {
      BookingObserver bo = (BookingObserver) e.nextElement() ;
      bo.update() ;
    }
  }
  ...
  {
    selectedBooking = null ;
    Enumeration<Booking> e = currentBookings.elements() ;
    while (e.hasMoreElements()) {
  ...
  private boolean doubleBooked(Time startTime, int tno, Booking ignore)
  {
    ...
    Enumeration<Booking> e = currentBookings.elements() ;
    while (!doubleBooked && e.hasMoreElements()) {
      Booking b = (Booking) e.nextElement() ;
